...
| **Neon production DB**                    | [docs/runbooks/neon-production-setup.md](docs/runbooks/neon-production-setup.md) — Neon project, pooled URL, prisma migrate deploy, cold start mitigation                                                             |
| **Fly.io production deploy**              | [docs/runbooks/flyio-production-setup.md](docs/runbooks/flyio-production-setup.md) + [apps/api/fly.production.toml](apps/api/fly.production.toml) — production app, secrets, custom domain, CI auto-deploy            |
| **AWS ECS Fargate deploy / cutover**      | [docs/runbooks/aws-ecs-deploy.md](docs/runbooks/aws-ecs-deploy.md) + [.github/workflows/deploy-aws-ecs.yml](.github/workflows/deploy-aws-ecs.yml) — ECR push, task def render, ECS service update, auto-scaling       |
| **CloudWatch alarms / production alerts** | [docs/runbooks/cloudwatch-alarms.md](docs/runbooks/cloudwatch-alarms.md) + [infrastructure/modules/observability/](infrastructure/modules/observability/) — 7 alarms over SNS email, test procedures, false positives |
| **Publish a free public demo**            | [docs/runbooks/public-demo-deploy.md](docs/runbooks/public-demo-deploy.md) — master checklist (Vercel + Fly.io + Neon + R2 + Resend + Stripe test), $0/mo, no domain needed                                           |
| **Cloudflare R2 image storage**           | [docs/runbooks/cloudflare-r2-setup.md](docs/runbooks/cloudflare-r2-setup.md) — S3-compatible bucket, CORS, public domain, migration path к AWS S3                                                                     |
| **Stripe BNPL (Klarna / Afterpay)**       | [docs/runbooks/stripe-bnpl-setup.md](docs/runbooks/stripe-bnpl-setup.md) + [apps/web/src/lib/installment-preview.ts](apps/web/src/lib/installment-preview.ts) — Stripe Dashboard activation, installment preview UI   |
