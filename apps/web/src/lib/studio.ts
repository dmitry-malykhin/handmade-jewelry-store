 ...
 *
 * Surfaces the maker / origin so customers can see who crafted their piece.
 * "Made in [city]" carries +3-6% conversion lift on premium handmade per Etsy
 * seller research (see docs/19).
 */
